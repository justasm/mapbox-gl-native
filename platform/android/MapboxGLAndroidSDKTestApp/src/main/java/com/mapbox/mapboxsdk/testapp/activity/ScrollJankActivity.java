...
public class ScrollJankActivity extends AppCompatActivity {
    ...
    private void initSelectedFragment() {
        ...
        SupportMapFragment mapFragment = SupportMapFragment.newInstance(
                createMapOptions(this, useSurfaceView));
    ...
    private static MapboxMapOptions createMapOptions(Context context, boolean useSurfaceView) {
        MapboxMapOptions options = new MapboxMapOptions();
        options.accessToken(ApiAccess.getToken(context));
